...
export class CreateUserComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.userNameCtrl = this.formBuilder.control('', [Validators.required, Validators.minLength(5)]);
    ...
    this.passwordCtrl = this.formBuilder.control('', [Validators.required, Validators.pattern('(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&].{7,}')]);
